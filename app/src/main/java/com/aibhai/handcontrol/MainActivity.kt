...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(body("⬆️ Swipe hand up → Brightness up"))
        root.addView(body("⬇️ Swipe hand down → Brightness down"))
        root.addView(body("⬅️ Swipe hand left → Swipe left"))
        root.addView(body("➡️ Swipe hand right → Swipe right"))
